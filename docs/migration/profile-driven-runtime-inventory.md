...
| Per-agent homes | `agents/*/home/` | Removed from active tree after extracting the v1 profile sources into `profiles/<profile>/` and canonical shared skills into `shared/skills/`. Current generated Docker profile homes live under ignored `runtime/hermes/profiles/<profile>/`; do not reintroduce `agents/*` as a runtime compatibility path. |
