...
- Use only active Team Nexus profile assignees from `profiles/team-nexus.profiles.yaml` or rendered profile context. Do not rely on a memorized roster or invent role labels as assignees.
